...
git fetch qcacld-3.0 LA.UM.9.1.r1-11900-SMxxx0.0
...
git fetch fw-api LA.UM.9.1.r1-11900-SMxxx0.0
...
git fetch qca-wifi-host-cmn LA.UM.9.1.r1-11900-SMxxx0.0
...
git fetch techpacka LA.UM.9.1.r1-11900-SMxxx0.0
...
git fetch techpackd LA.UM.9.1.r1-11900-SMxxx0.0
